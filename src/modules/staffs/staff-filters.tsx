...
export type StaffStatus = "ACTIVE" | "DEACTIVE";
...
const StaffFilters = () => {
  ...
  const [tempSelectedStatus, setTempSelectedStatus] = useState<
    StaffStatus | ""
  >(selectedStatus as StaffStatus | "");

  const handleTempStatusChange = (status: StaffStatus | "") => {
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="flex gap-2">
            <Sheet
              open={open}
              onOpenChange={(e) => {
                setTempSelectedStatus(selectedStatus as StaffStatus | "");
                setOpen(e);
              }}
            >
              ...
              <SheetContent className="overflow-y-auto">
                <SheetHeader>
                  <SheetTitle>Filter Staffs</SheetTitle>
                </SheetHeader>
                <div className="py-6 space-y-6">
                  <div className="space-y-3">
                    ...
                    <RadioGroup
                      ...
                      onValueChange={(value) =>
                        handleTempStatusChange(value as StaffStatus | "")
                      }
                    >
