...
const CategoryFilters = () => {
  ...
  const [tempSelectedStatus, setTempSelectedStatus] = useState<
    CategoryStatus | ""
  >(selectedStatus as CategoryStatus | "");

  const handleTempStatusChange = (status: CategoryStatus | "") => {
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="flex gap-2">
            <Sheet
              open={open}
              onOpenChange={(e) => {
                setTempSelectedStatus(selectedStatus as CategoryStatus | "");
                setOpen(e);
              }}
            >
              ...
              <SheetContent className="overflow-y-auto">
                <SheetHeader>
                  <SheetTitle>Filter Categorys</SheetTitle>
                </SheetHeader>
                <div className="py-6 space-y-6">
                  <div className="space-y-3">
                    ...
                    <RadioGroup
                      ...
                      onValueChange={(value) =>
                        handleTempStatusChange(value as CategoryStatus | "")
                      }
                    >
