...
export type CustomerStatus = "ACTIVE" | "DEACTIVE";
...
const CustomerFilters = () => {
  ...
  const [tempSelectedStatus, setTempSelectedStatus] = useState<
    CustomerStatus | ""
  >(selectedStatus as CustomerStatus | "");

  const handleTempStatusChange = (status: CustomerStatus | "") => {
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="flex gap-2">
            <Sheet
              open={open}
              onOpenChange={(e) => {
                setTempSelectedStatus(selectedStatus as CustomerStatus | "");
                setOpen(e);
              }}
            >
                ...
                <div className="py-6 space-y-6">
                  <div className="space-y-3">
                    ...
                    <RadioGroup
                      ...
                      onValueChange={(value) =>
                        handleTempStatusChange(value as CustomerStatus | "")
                      }
                    >
