...
export type BrandStatus = "ACTIVE" | "DEACTIVE";
...
const BrandFilters = () => {
  ...
  const [tempSelectedStatus, setTempSelectedStatus] = useState<
    BrandStatus | ""
  >(selectedStatus as BrandStatus | "");

  const handleTempStatusChange = (status: BrandStatus | "") => {
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="flex gap-2">
            <Sheet
              open={open}
              onOpenChange={(e) => {
                setTempSelectedStatus(selectedStatus as BrandStatus | "");
                setOpen(e);
              }}
            >
                ...
                <div className="py-6 space-y-6">
                  <div className="space-y-3">
                    ...
                    <RadioGroup
                      ...
                      onValueChange={(value) =>
                        handleTempStatusChange(value as BrandStatus | "")
                      }
                    >
