...
export type OrderStatus = "ACTIVE" | "DEACTIVE";
...
const OrderFilters = () => {
  ...
  const handleTempStatusChange = (status: OrderStatus | "") => {
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="flex gap-2">
            <Sheet
              open={open}
              onOpenChange={(e) => {
                setTempSelectedStatus(selectedStatus as OrderStatus | "");
                setOpen(e);
              }}
            >
                ...
                <div className="py-6 space-y-6">
                  <div className="space-y-3">
                    ...
                    <RadioGroup
                      ...
                      onValueChange={(value) =>
                        handleTempStatusChange(value as OrderStatus | "")
                      }
                    >
