...
export type InventoryStatus = "ACTIVE" | "DEACTIVE";
...
const InventoryFilters = () => {
  ...
  const [tempSelectedStatus, setTempSelectedStatus] = useState<
    InventoryStatus | ""
  >(selectedStatus as InventoryStatus | "");

  const handleTempStatusChange = (status: InventoryStatus | "") => {
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="flex gap-2">
            <Sheet
              open={open}
              onOpenChange={(e) => {
                setTempSelectedStatus(selectedStatus as InventoryStatus | "");
                setOpen(e);
              }}
            >
              ...
              <SheetContent className="overflow-y-auto">
                <SheetHeader>
                  <SheetTitle>Filter Inventories</SheetTitle>
                </SheetHeader>
                <div className="py-6 space-y-6">
                  <div className="space-y-3">
                    ...
                    <RadioGroup
                      ...
                      onValueChange={(value) =>
                        handleTempStatusChange(value as InventoryStatus | "")
                      }
                    >
