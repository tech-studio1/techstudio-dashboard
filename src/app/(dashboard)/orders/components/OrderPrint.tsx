...
export const OrderPrint = forwardRef<HTMLDivElement, OrderPrintProps>(
  function OrderPrint({ order, outlet }, ref) {
    ...
    return (
      <div
        ref={ref}
        className="order-print bg-white text-black relative"
        style={{
          width: "210mm",
          minHeight: "297mm",
          margin: "0 auto",
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-8 mb-5">
          ...
          <div>
            ...
            {order.customer || order.client_info?.billingAddress ? (
              <div className="space-y-1">
                ...
                {order.client_info?.shippingAddress && (
                  <div className="mt-4">
                    ...
                    <div className="text-sm">
                      <p>
                        {order.client_info.shippingAddress.firstName}{" "}
                        {order.client_info.shippingAddress.lastName}
                      </p>
                      <p>{order.client_info.shippingAddress.mobile}</p>
                      <p>{order.client_info.shippingAddress.address}</p>
                      <p>
                        {order.client_info.shippingAddress.city},{" "}
                        {order.client_info.shippingAddress.district}
                      </p>
                    </div>
                  </div>
                )}
          ...
          <div>
            ...
            <div className="space-y-1">
              ...
              <div className="flex">
                <span className="font-semibold text-gray-800 w-24">Type:</span>
        ...
        >
          <div className="mb-2">
            ...
            <p className="text-gray-600 text-sm">We appreciate your business</p>
          </div>
          <div className="text-sm text-gray-700 space-y-0.5">
        ...
        <style jsx>{`
          @media print {
            ...
            /* Hide everything except the order print */
            body * {
              visibility: hidden;
            }
